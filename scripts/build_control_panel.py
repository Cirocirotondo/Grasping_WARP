...
WAVE = {
    "title": "Waves 1-6 (Newton/MuJoCo-Warp fleet, 2026-09-17/18): success criterion met by w6_ref_ori_lowlr @14600 (83% of the bank within 7 cm from frame 0, pose 122 perfect);: pose 122 solved (w2_one_cont @8000); origin-anchored widening reproducible (w4_bank_mix pair, ~0.55 fail from frame 0, 0.30 from the pregrasp); wave 5 attacks oscillation and orientation. Earlier:: pose 122 solved by w2_one_cont @8000 (R0 recipe, 8000 iterations); wave 3 = hold robustness + widening to the whole bank",
