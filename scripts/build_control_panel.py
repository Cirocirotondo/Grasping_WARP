...
WAVE = {
    ...
    "runs": {
        ...
        "s2_anchor25_s7": {"change": "WAVE S2 (tars 1): §11 recipe + scale anchor 25%, seed 7, 17000->17800, ladder every 100", "question": "does the anchor prevent the seed-7 dive?"},
        "s2_anchor50_s42": {"change": "WAVE S2 (tars 0, after s23): §11 recipe + scale anchor 50%, seed 42, 17000->17800", "question": "stronger anchor: does the 0.8 side still improve?"},
        ...
        "s2_anchor25_s42": {"change": "WAVE S2 (desktop): §11 recipe + scale anchor 25% nominal bars, seed 42, short budget 17000->17800, ladder every 100 at three scales", "question": "PARTLY: 17100 beats the baseline at 1.0 on every column (0.344, fail@10 0.012) with pose 122 250/250; collapse moved to +400 (violent at 17600); 0.8/1.2 pending"},
        "s2_anchor25_lr1e5_s42": {"change": "WAVE S2 (desktop): scale anchor 25% + lr 1e-5, seed 42, 17000->17800", "question": "do anchor and a halved step push the collapse beyond +800 and widen the good window?"},
        ...
        "s2_lr5e6_s42": {"change": "WAVE S2 (case 0): §11 recipe without anchor, lr 5e-6, seed 42, 17000->18000", "question": "control: does a 4x smaller step widen the peak window?"},
        "s2_anchor25_fromcurr42": {"change": "WAVE S2 (case 1): scale anchor 25% on the best-anchored substrate (curr_s42 model_18000, pose 122 at every scale), seed 42, 18000->18800", "question": "does the anchor bring 0.8 under 0.45 without losing pose 122?"},
