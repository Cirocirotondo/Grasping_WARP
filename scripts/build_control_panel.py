...
WAVE = {
    "title": "Scale ±20% — waves S1–S3 closed (2026-09-18 22:45 CEST). Branch generalize_size, cuboid scale in [0.8, 1.2] observed by the policy, warm start from w6_ori_soft_s7_cont2 @17000 (widened input). Baseline zero-shot bank fail@7 from frame 0: 0.8 -> 0.748, 0.9 -> 0.492, 1.0 -> 0.396, 1.1 -> 0.348, 1.2 -> 0.376. ~40 runs on tars / case / desktop, one §11 hit: s2_lr5e6_s42 model_17300. Earlier: pose campaign closed 10:35 — deliverable w6_ori_soft_s7_cont2 @17000 (user's choice, best arm tracking by eye)",
