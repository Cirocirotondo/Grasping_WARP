...
WAVE = {
    ...
    "runs": {
        ...
        "s1_scale_noobs_s7": {"change": "WAVE S1 (case 1): scale [0.8, 1.2] WITHOUT the scale observation (plain 112-input seed)", "question": "control: is the scale observation needed, or does contact feedback suffice?"},
        "s1_scale_u73_s7": {"change": "WAVE S1 (desktop): scale [0.7, 1.3] with the factor observed", "question": "does over-covering the range make +-20% easier?"},
