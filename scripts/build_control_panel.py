...
WAVE = {
    ...
    "runs": {
        ...
        "s2_anchor25_s7": {"change": "WAVE S2 (tars 1): §11 recipe + scale anchor 25%, seed 7, 17000->17800, ladder every 100", "question": "YES: 17300 = 0.460/0.264/0.510 at 0.8/1.0/1.2 (baseline 0.748/0.396/0.376), pose 122 242/250/115 — two sides beaten, 1.2 now the binding side"},
        "s2_lr5e6_s23": {"change": "WAVE S2 (tars 0, after anchor2p): lr 5e-6, no anchor, seed 23, 17000->18000", "question": "STOPPED by §10 at 17537: peak at 17200 (0.367 at 1.0, pose 122 250/250) then the bar is thrown at +400 — the small step delays the walk-off, it does not prevent it"},
        "s2_only12_s42": {"change": "WAVE S2 (tars 1, after lr2p5e6): lr 5e-6, scale fixed at 1.2 only, seed 42, 17000->17800", "question": "diagnostic: can the large bar alone beat the zero-shot 0.376 at 1.2? if not, no mixed-scale schedule will"},
        "s2_lr5e6_anchor25_s42": {"change": "WAVE S2 (tars 0): lr 5e-6 + nominal anchor 25% (no 1.2 anchor), seed 42, 17000->17800", "question": "does the nominal anchor widen the small-step window without costing 0.8?"},
        "s2_lr2p5e6_s42": {"change": "WAVE S2 (tars 1, after anchor3p): lr 2.5e-6, no anchor, seed 42, 17000->18000", "question": "WIDENS it: every rung alive at 1.0 (near-band 33-65), peak 17300 = 0.362, plateau 0.36-0.54 over ±200 — extremes pending"},
        "s2_anchor3p_s7": {"change": "WAVE S2 (tars 1): anchors 1.0 at 25%, 1.2 at 15%, 0.8 at 15% (45% uniform), seed 7, 17000->17800", "question": "17100 = 0.300/0.466/0.968, pose 122 250/250/0 — best small-bar number of the campaign, worst 1.2 of any anchored rung; anchoring is not symmetric, one-rung window"},
        "s2_anchor2p_s7": {"change": "WAVE S2 (tars 0, after s23): §11 recipe + anchors 1.0 at 25% and 1.2 at 15% (scale_anchors), seed 7, 17000->17800", "question": "SPLIT: 17100 = 0.430/0.384/0.752, pose 122 235/250/250 — the 1.2 anchor fixes pose 122 at 1.2 (115 -> 250) and worsens the bank at 1.2 (0.492 -> 0.752); scale and pose anchors multiply, they do not add"},
        ...
        "s2_anchor25_s42": {"change": "WAVE S2 (desktop): §11 recipe + scale anchor 25% nominal bars, seed 42, short budget 17000->17800, ladder every 100 at three scales", "question": "17100 = 0.300/0.344/0.598 at 0.8/1.0/1.2, pose 122 250/250/236 — best hard side of the campaign, not deliverable by 4 roll-outs at 1.2; the nominal anchor trades the large bar for the small one"},
        "s2_lr5e6_cont17300_s42": {"change": "WAVE S2 (desktop, after anchor2p_s42): the scale deliverable s2_lr5e6_s42 model_17300 continued 800 more at lr 5e-6 (17300->18100)", "question": "does the small-step window advance instead of collapsing?"},
        "s2_anchor2p_s42": {"change": "WAVE S2 (desktop, after lr1e5): anchors 1.0 at 25% + 1.2 at 15%, seed 42, 17000->17800", "question": "17400 = campaign-best 1.2 (0.378, near-band 77, orientation 0.280) with 0.8 at 0.796 and pose 122 1/250 — the anchor re-allocates capacity, it does not widen it; deliverable rung 17100 (0.396/0.356/0.677, pose 122 full)"},
        "s2_anchor25_lr1e5_s42": {"change": "WAVE S2 (desktop): scale anchor 25% + lr 1e-5, seed 42, 17000->17800", "question": "CORRECTED: dies at 17300 and comes back — 17600 = 0.208/0.232/0.424 (all under 0.45, lowest median errors of the campaign) but pose 122 240/250/39: bank criterion met, deliverability lost at 1.2; isolated peak"},
        ...
        "s2_lr5e6_s42": {"change": "WAVE S2 (case 0): §11 recipe without anchor, lr 5e-6, seed 42, 17000->18000", "question": "MEETS §11 (two sweep seeds): 17300 = 0.416/0.316/0.438, pose 122 249.5/250/241, palm -9..-15% vs reference, 3-rung window — the scale deliverable candidate"},
        "s2_lr5e6_s7": {"change": "WAVE S2 (case 1): lr 5e-6, no anchor, seed 7, 17000->18000", "question": "largely the seed: seed 7 gives the campaign-best 0.8 (0.292 at 17300) but loses 1.2 (0.884) and pose 122 (130/250); no rung meets the criterion at all three scales"},
        "s2_lr5e6_anchor2p_s42": {"change": "WAVE S2 (case 0, after lr5e6_s42): lr 5e-6 + anchors 1.0 at 25% and 1.2 at 15%, seed 42, 17000->17800", "question": "17700 = 0.240/0.360/0.496 (campaign-best 0.8), near-band 72/100, pose 122 250/250 — but 1.2 above 0.45 and median orientation 0.655 rad (§9 DQ); duplicates pending"},
        "s2_lr5e6_s11": {"change": "WAVE S2 (case 1): lr 5e-6, no anchor, seed 11, 17000->17600 (small-step seed lottery)", "question": "a wider or better window than seed 42?"},
        "s2_lr5e6_s3": {"change": "WAVE S2 (case 0): lr 5e-6, no anchor, seed 3, 17000->17600 (small-step seed lottery)", "question": "a wider or better window than seed 42?"},
        "s2_anchor25_fromcurr42": {"change": "WAVE S2 (case 1): scale anchor 25% on the best-anchored substrate (curr_s42 model_18000, pose 122 at every scale), seed 42, 18000->18800", "question": "NO on the bank: near-band 60/100 and pose 122 kept for two rungs, but 0.8 stays at 0.840 — anchoring preserves, it does not buy the small-bar skill"},
